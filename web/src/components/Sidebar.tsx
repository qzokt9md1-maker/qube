...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-[275px] flex flex-col px-3 py-2 border-r border-[var(--qube-border)] xl:w-[275px] lg:w-[88px] max-lg:hidden">
      ...
      {/* Post button */}
      <button className="mt-4 xl:w-full lg:w-12 lg:h-12 lg:mx-auto bg-[var(--qube-primary)] hover:bg-[var(--qube-primary-dark)] text-white font-bold xl:py-3 rounded-full transition-colors">
        <span className="xl:inline lg:hidden">Post</span>
        <svg className="w-6 h-6 xl:hidden lg:block hidden mx-auto" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="mt-auto mb-3">
        <button className="flex items-center gap-3 w-full p-3 rounded-full hover:bg-[var(--qube-surface-hover)] transition-colors">
          ...
          <svg className="w-4 h-4 text-[var(--qube-text-secondary)] xl:block lg:hidden" fill="currentColor" viewBox="0 0 24 24">
